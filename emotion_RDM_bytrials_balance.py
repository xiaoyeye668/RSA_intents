...
search_list = ['attitude','valence','arousal']
search_list = ['valence','arousal']
search_list = ['valence','attitude']
...
def emoRDM(emotion_data, method="correlation", abs=False):
    ...
    assert emotion_data.shape[0] == 60
...
f = h5py.File("rdms/emotion_euclidean_bytrials_2dim_balance_2.h5", "w")
