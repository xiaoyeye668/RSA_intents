...
search_list = ['meanintensity','pitchMax', 'pitchrange']
search_list = ['meanintensity','pitchMax', 'f3meanfrequency']
search_list = ['meanintensity','duration','pitchMax']
...
def audRDM(auditory_data, method="correlation", abs=False):
    ...
    assert auditory_data.shape[0] == 60
...
f = h5py.File("rdms/logauditory_euclidean_bytrials_3dim_balance_3.h5", "w")
